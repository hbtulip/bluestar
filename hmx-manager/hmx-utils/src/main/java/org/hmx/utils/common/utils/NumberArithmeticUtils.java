...
public class NumberArithmeticUtils {  
	 ...
	 * @return
	 */
	public static BigDecimal formatScale2(BigDecimal bd){
		if(bd ==null){
			bd = BigDecimal.ZERO;
		}
	 ...
	 * @return
	 */
	public static BigDecimal convertFromStr(String str){
   ...
   /** 
     * BigDecimal的加法运算封装      * @author : shijing 
     * 2017年3月23日下午4:53:21 
     * @param b1 
     * @param bn 
     * @return 
   ...
   * @param b2 
   ...
   /**
    * BigDecimal转换为字符串
    * @param stripTrailingZeros 是否忽略尾部0
    * Created by wangwei on 2019-04-18
    */
   public static String toPlainString(BigDecimal decimal, boolean stripTrailingZeros) {
       if (decimal == null) {
           return "";
       }
